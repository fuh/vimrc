...
" Ctrl + R                   --运行 [支持C/C++、Java、Bash、Lua、Python]
" Ctrl + ]                   --转到函数定义
" Ctrl + T                   --返回调用函数
...
let g:vimwiki_list = [{
\ 'path': '/host/Apps/Gvim/mysite/wiki',
\ 'path_html': '/host/Apps/Gvim/mysite/html/',
\ 'html_header': '/host/Apps/Gvim/mysite/template/header.html',
\ 'html_footer': '/host/Apps/Gvim/mysite/template/footer.html',
\ 'auto_export': 1,
